...
void Renderer::render(const ProtogenHeadState& data, ICanvas& canvas) {
    //std::lock_guard<std::mutex> lock(m_mutex);
    viewProtogenHeadData(data, canvas);
}

const EmotionDrawer &Renderer::emotionDrawer() const
{
    return m_emotionDrawer;
}
