...
ImageSpectrum::ImageSpectrum() { std::cout << "ImageSpectrum initialized with no images." << std::endl; }
...
ImageSpectrum::ImageSpectrum(const std::string& images_directory) {
    ...
    std::cout << "Image spectrum initialized with " << m_images.size() << " images." << std::endl;
    std::cout << "Spectrum buckets: " << m_spectrum.bucket(0.0) << " to " << m_spectrum.bucket(1.0) << std::endl;
    std::cout << "Constructed with: " << images_directory << std::endl;
}
